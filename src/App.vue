<template>
    <div id="app">
        ...
        <div class="lang-switch">
            <button class="common" @click="lang = 'en'">English</button>
...
<style scoped>
    #app {
        background: url(./assets/background3.png) no-repeat center center fixed;
    ...
    /* BUTTON */
    button.common {
        background-image: url(./assets/button_common.png);
        color: white;
        font-weight: 600;
